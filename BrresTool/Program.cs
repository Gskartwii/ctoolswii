...
namespace Chadsoft.CTools.Brres
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (instance = new BrresToolInstance(args))
            {
                instance.Run();
            }
        ...
        {
            manager = new ResourceManager("Chadsoft.CTools.Brres.Properties.StringResource", typeof(Program).Assembly);
        }
