...
{
    public class BtiEditorInstance : EditorInstance, IDisposable
    {
        private bool disposed;
        private Editor _editor;
        private string path;

        internal BtiImage Image { get; set; }
        internal BtiEditorForm MainWindow { get; private set; }
        ...
        public BtiEditorInstance(string[] args)
            : base(null, null, null)
        {
            Name = null;
        ...
        public BtiEditorInstance(byte[] data, string name, Editor editor, EventHandler<SaveEventArgs> saveEvent, EventHandler closeEvent)
        ...
        {
            MainWindow = new BtiEditorForm(this);
            MainWindow.Show();
        }
